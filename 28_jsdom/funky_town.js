...
//var param1 = document.getElementById("param1").innerHTML;
//var param2 = document.getElementById("param2").innerHTML;
//document.getElementById("param2").innerHTML = -6;
...
var randgcd = function(){
    ...
    //num1 = param1;
    //num2 = param2;
    var output = "GCD of " + num1 + " and " + num1 + ": " + gcd(num1,num2);
    document.getElementById("output").innerHTML = output;
    console.log(output);
};
